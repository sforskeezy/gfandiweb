...
function ApplyPageInner() {
  ...
  const inputCls = "w-full rounded-2xl border-2 border-[#EEECEA] bg-[#FAF9F7] px-5 py-3.5 text-[0.85rem] font-medium text-[#1A1A1A] outline-none transition-all placeholder:font-normal placeholder:text-[#D0D0D0] focus:border-[#7B8C6F] focus:bg-white";
          ...
          {submitted ? (
            ...
            >
              ...
              <p className="mt-3 max-w-md text-[0.95rem] text-[#999]">
                Check your inbox for a confirmation email. We&apos;ll review your request and get back to you within 24 hours with a custom quote.
              </p>
              <Link
                href="/"
            ...
            <motion.div key="form" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              {step === 1 && (
                ...
                >
                  ...
                  <p className="mt-3 text-[0.95rem] text-[#999]">
                    Select all the services you&apos;re interested in. We&apos;ll build a custom quote around them.
                  </p>
              ...
              {step === 2 && (
                ...
                >
                  ...
                  <p className="mt-3 text-[0.95rem] text-[#999]">
                    Fill in your details so we can get back to you with a custom quote.
                  </p>
